...
export const merchants = pgTable(
  "merchants",
  {
    ...
    preferredSettlementCurrency: varchar("preferredSettlementCurrency", { length: 20 }).default("USD"),
    autoConvertEnabled: integer("autoConvertEnabled").default(0).notNull(),
...
export const transactions = pgTable(
  "transactions",
  {
    ...
    customerCurrency: varchar("customerCurrency", { length: 20 }),
    customerAmount: numeric("customerAmount", { precision: 36, scale: 18 }),
    fxRate: numeric("fxRate", { precision: 20, scale: 8 }),
    fxConverted: integer("fxConverted").default(0).notNull(),
    settlementCurrency: varchar("settlementCurrency", { length: 20 }),
